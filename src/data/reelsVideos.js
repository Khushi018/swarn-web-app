...
// One video per industry group (primary video only)
// Edit the 'raw' array below to change which videos appear in Reels
// Additional videos from the same industry appear in Stories instead
...
// Edit this array to change which videos appear in Reels
// Only include ONE video per industry group (e.g., one "Chai", one "Child Care", etc.)
const raw = [
  {
...
#DhandeKiBaat #SaffronFarming #IndoorFarming #BusinessIdeas #retirementplanning`,
  ...
  },
  {
    ...
    caption: `Green cement? I thought cement was just... cement. Turns out I was completely wrong.
I attended Adani Cement's NirmAAAnotsav event in Jabalpur and learned something that's going to change India's construction industry.
Green concrete is already here. Not "coming soon" - already being delivered.
Adani (9th largest cement company globally) has partnered with CREDAI to make sustainable construction actually practical and scalable.
Here's what caught my attention:
They have India's largest R&D lab where AI and robotics are being used to develop sustainable cement. Not just for show - for actual Net Zero goals.
But here's the kicker: Government is now offering extra FSI and tax benefits for green buildings.
Which means builders have a financial incentive to go green, not just a moral one.
What's your take on sustainable construction? Drop your thoughts below.
#nirmaaanotsav #business #india`,
...
export const reelsVideos = raw.map((item, idx) => ({
  id: idx,
  ...item,
  author: item.company,
